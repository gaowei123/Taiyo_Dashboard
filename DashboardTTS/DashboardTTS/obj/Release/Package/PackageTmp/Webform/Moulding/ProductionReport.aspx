<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="ProductionReport.aspx.cs" Inherits="DashboardTTS.Webform.Molding.ProductionReport" %>
    ...
    <table style =" padding: 0px; width: 100%; border-collapse: separate; border-spacing: 10px; table-layout: auto; line-height: 10px; vertical-align: 10%;">
        <tr style ="width: 100%">
            <td style = "padding: 10px 10px 10px 25px; border: 1px solid #CCCCCC; font-family: 'Arial Unicode MS'; height: 50px; background-color: #003366; font-weight: bold;" colspan="5"> 
                <img src="../../Resources/Images/headericon.gif" alt="" style="width: 15px; height: 15px" /> <Asp:label ID="lblUserHeader"   runat="server" Font-Names="Arial Unicode MS"  Text="Moulding Production Real Time" Font-Size="12" ForeColor="White"></Asp:label>
            </td>
        </tr>
        <tr style ="width: 100%">
            ...
            <td style = "padding: 10px; border: 1px solid #CCCCCC; width: 20%; font-family: 'Arial Unicode MeS'; height: 50px;"></td>
        </tr>
        <tr style="width:100%">
            <td style = "padding: 10px 10px 10px 25px; border: 1px solid #CCCCCC; width: 15%; font-family: 'Arial Unicode MS'; height: 50px;"> 
        ...
        <tr style ="width: 100%">
            ...
            <td style =" border: 1px solid #CCCCCC; padding: 10px 35px 10px 10px; width: 25%; height: 50px; ">
                <igsch:WebDateChooser ID="infDchTo" runat="server"  Height="23px"  Width="100%"></igsch:WebDateChooser></td>                                                      
            <td style = "padding: 10px; border: 1px solid #CCCCCC; width: 20%; font-family: 'Arial Unicode MS'; height: 50px;">
        ...
        <tr id="trChart" style ="width: 100%">
            <td style = "padding: 10px 4px 10px 4px; border: 1px solid #CCCCCC; width:100%;  font-family: 'Arial Unicode MS'; height: 50px;" colspan="5" aria-hidden="False" aria-multiline="True" aria-multiselectable="True" aria-orientation="vertical" draggable="false"> 
                <asp:DataGrid runat="server" CssClass="table table-hover" Width ="100%" ID ="dg_Report" CellPadding="2" ForeColor="#333333" GridLines="None" CellSpacing="2" AutoGenerateColumns="false" >
                    ...
                    <Columns>
                        ...
                        <asp:BoundColumn DataField="Time" HeaderText="Daily Run Time"></asp:BoundColumn>    
                        <asp:BoundColumn DataField="NeedProductionTime" HeaderText="Remains Time"></asp:BoundColumn> 
                        <asp:BoundColumn DataField="AdjustScrap" HeaderText="Adjust Scrap"></asp:BoundColumn> 
