                            ...
                            <td style = "padding: 25px 25px 25px 25px; border: 1px solid #CCCCCC; width:100%;  font-family: 'Arial Unicode MS'; height: 50px;" colspan="5" aria-hidden="False" aria-multiline="True" aria-multiselectable="True" aria-orientation="vertical" draggable="false"> 
                                ...
                                <SelectedItemStyle BackColor="#E2DED6" Font-Bold="True" ForeColor="#333333" />
                                    <Columns>
                                        ...
                                        <asp:TemplateColumn HeaderText="SetUp Qty" Visible="false">
                                            <ItemTemplate>
                                                <asp:TextBox runat="server" ID ="txt_Setup" Height="20px" ></asp:TextBox>
                                            </ItemTemplate>
                                        </asp:TemplateColumn>
                                        <asp:TemplateColumn HeaderText="Wasted Material01" Visible="false">
                                            <ItemTemplate>
                                                <asp:TextBox runat="server" ID ="txt_WasteMaterial01" Height="20px" ></asp:TextBox>
                                            </ItemTemplate>
                                        </asp:TemplateColumn>
                                        <asp:TemplateColumn HeaderText="Wasted Material02" Visible="false">
                                            <ItemTemplate>
                                                <asp:TextBox runat="server" ID ="txt_WasteMaterial02" Height="20px" ></asp:TextBox>
                                            </ItemTemplate>
                                        </asp:TemplateColumn>
