<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="AllMachineUtilizationRate.aspx.cs" Inherits="DashboardTTS.Webform.Reports.AllMachineUtilizationRate" %>
    ...
    <table style =" padding: 0px; width: 100%; border-collapse: separate; border-spacing: 10px; table-layout: auto; line-height: 10px; vertical-align: 10%;">
        ...
        <tr style ="width: 100%">
            <td style = "padding: 10px 10px 10px 25px; border: 1px solid #CCCCCC; font-family: 'Arial Unicode MS'; height: 50px; background-color: #003366; font-weight: bold;" colspan="5"> 
                ...
                <Asp:label ID="lblUserHeader"   runat="server" Font-Names="Arial Unicode MS"  Text="All Machine Utilization Chart" Font-Size="12" ForeColor="White"/>
            </td>
        </tr>
        ...
        <tr style ="width: 100%">
            ...
            <td style ="border: 1px solid #CCCCCC; padding: 10px 10px 10px 10px; width: 25%; height: 50px; ">
                <asp:DropDownList ID="ddlShift"  runat="server" Width="100%"  BorderWidth="1px" Height="23px" >
            ...
            <td style = "padding: 10px 10px 10px 25px; border: 1px solid #CCCCCC; width: 15%;   font-family: 'Arial Unicode MS'; height: 50px;" >
                ...
                <td style = "padding: 10px 10px 10px 10px; border: 1px solid #CCCCCC; width: 25%;   font-family: 'Arial Unicode MS'; height: 50px;">
        ...
        <tr style ="width: 100%">
            ...
            <td style ="border: 1px solid #CCCCCC; padding: 10px 10px 10px 10px; width: 25%; height: 50px; ">
                <asp:DropDownList runat="server" ID="ddlType" Height="23px" Width="100%">
                    ...
                    <asp:ListItem Text="Utilization" Value="Utilization"></asp:ListItem>                    
                </asp:DropDownList>
            </td>
            <td style = "padding: 10px 10px 10px 25px; border: 1px solid #CCCCCC; width: 15%; font-family: 'Arial Unicode MS'; height: 50px;"> 
        ...
        <tr id="trChart" style ="width: 100%">
            <td style = "padding: 25px 25px 25px 25px; border: 1px solid #CCCCCC;   font-family: 'Arial Unicode MS'; height: 50px;" colspan="5" aria-hidden="False" aria-multiline="True" aria-multiselectable="True" aria-orientation="vertical" draggable="false"> 
                ...
                <asp:Chart ID="chartUsage"  runat="server" Width="1330px" Height="600px" BackColor="245, 245, 250" BorderlineColor="Black" ImageType="Bmp" ImageLocation="~/TempImages/ChartPic_#SEQ(300,3)">
                        <Series>
