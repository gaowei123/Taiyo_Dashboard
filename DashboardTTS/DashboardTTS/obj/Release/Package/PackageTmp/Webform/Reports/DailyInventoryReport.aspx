<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DailyInventoryReport.aspx.cs" MasterPageFile="~/Site.Master" Inherits="DashboardTTS.Webform.Reports.DailyInventoryReport" %>
        ...
        <table style =" padding: 0px; width: 100%; border-collapse: separate; border-spacing: 10px; table-layout: auto; line-height: 10px; vertical-align: 10%;">
            ...
            <tr style ="width: 100%">
                <td style = "padding: 10px 10px 10px 25px; border: 1px solid #CCCCCC; width: 150px;   font-family: 'Arial Unicode MS'; height: 50px;"> 
                    <asp:Label runat="server" Text="Lot No :" Width="100%" />
                </td>
                <td style ="border: 1px solid #CCCCCC; padding: 10px 35px 10px 10px; width: 250px; height: 50px;">
                    <asp:TextBox AutoCompleteType="Disabled" runat="server" ID="txtLotNo" Width="100%" BorderStyle="Solid" BorderWidth="1px" Height="23px" ></asp:TextBox>
                </td>
                <td style = "padding: 10px 10px 10px 25px; border: 1px solid #CCCCCC; width: 150px; font-family: 'Arial Unicode MS'; height: 50px;"> 
                ...
                <td style = "padding: 10px; border: 1px solid #CCCCCC; width: auto; font-family: 'Arial Unicode MeS'; height: 50px;" colspan="3">
            ...
            <tr style ="width: 100%">
                ...
                <td style = "padding: 10px 10px 10px 25px; width: 150px; border: 1px solid #CCCCCC;   font-family: 'Arial Unicode MS'; height: 50px;"> 
                    <asp:Label runat="server" Text="Date :" Width="100%" />
                </td>
                <td style ="border: 1px solid #CCCCCC; padding: 10px 35px 10px 10px; width: 250px; height: 50px; ">
            ...
            <tr id="trChart" style ="width: 100%">
                <td style = " border: 1px solid #CCCCCC;   font-family: 'Arial Unicode MS'; height: 50px; " colspan="9">
                    ...
                    <div style="overflow: scroll; width:1840px;height:560px;">
                        <asp:DataGrid runat="server" CssClass="table table-hover" Width ="100%" ID ="dgPQCLaserTotalReport" CellPadding="10" ForeColor="#333333" GridLines="None" CellSpacing="2" AutoGenerateColumns="false" style="line-height:15px" >
