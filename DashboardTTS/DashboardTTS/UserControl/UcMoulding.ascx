<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcMoulding.ascx.cs" Inherits="DashboardTTS.UserControl.UcMoulding" %>
...
<table  class="tableBorder">
    ...
    <tr> 
        ...
        <td class="auto-style3 lbDescript">Model</td>          
        <td class="auto-style4">
    ...
    <tr>    
        ...
        <td class="auto-style3 lbDescript">Jig No</td>
        <td class="auto-style4">
            <asp:Label ID="lbJigNo" runat="server"></asp:Label>
        </td>
    </tr>

    <tr>   
        <td class="auto-style3 lbDescript">Total</td>          
        <td class="auto-style4" > 
