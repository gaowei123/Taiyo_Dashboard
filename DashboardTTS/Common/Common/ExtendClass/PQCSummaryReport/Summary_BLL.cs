...
namespace Common.ExtendClass.PQCSummaryReport
{
    public class Summary_BLL
    {
        ...
        public List<Summary_Model.Report> GetCheckingList(PQCSummaryParam param)
        {
            ...
            {
                DBHelp.Reports.LogFile.Log("PQCSummaryReportDebug", "add laser :"+e.ToString());
            }
            ...
            {
                DBHelp.Reports.LogFile.Log("PQCSummaryReportDebug", "add wip :" + e.ToString());
            }
            ...
            {
                DBHelp.Reports.LogFile.Log("PQCSummaryReportDebug", "add num :" + e.ToString());
            }
            ...
            {
                DBHelp.Reports.LogFile.Log("PQCSummaryReportDebug", "add laser total :" + e.ToString());
            }
            ...
            {
                DBHelp.Reports.LogFile.Log("PQCSummaryReportDebug", "add wip total :" + e.ToString());
            }
