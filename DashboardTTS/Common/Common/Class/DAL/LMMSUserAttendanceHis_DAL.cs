...
{
	/// <summary>
	/// 数据访问类:LMMSUserAttendanceHis_DAL
	/// </summary>
	public class LMMSUserAttendanceHis_DAL
	{
		public LMMSUserAttendanceHis_DAL()
		{}
		#region  Method
		...
		public void Add(Common.Model.LMMSUserAttendanceHis_Model model)
		{
			...
			strSql.Append("insert into LMMSUserAttendanceHis(");
		...
		public SqlCommand AddCommand(Common.Model.LMMSUserAttendanceHis_Model model)
		{
			...
			SqlParameter[] parameters = {
			 ...
			 DBHelp.Reports.LogFile.DebugLog("AUTOCODE","NameSpace:Common.DAL" , "Class:LMMSUserAttendanceHis_DAL" , "Function:		public SqlCommand AddCommand(Common.Model.LMMSUserAttendanceHis_Model model)"  + "TableName:LMMSUserAttendanceHis" , ";UserID = "+ (model.UserID == null ? "" : model.UserID.ToString()) + ";UserName = "+ (model.UserName == null ? "" : model.UserName.ToString()) + ";UserGroup = "+ (model.UserGroup == null ? "" : model.UserGroup.ToString()) + ";Department = "+ (model.Department == null ? "" : model.Department.ToString()) + ";Shift = "+ (model.Shift == null ? "" : model.Shift.ToString()) + ";Attendance = "+ (model.Attendance == null ? "" : model.Attendance.ToString()) + ";OnLeave = "+ (model.OnLeave == null ? "" : model.OnLeave.ToString()) + ";Day = "+ (model.Day == null ? "" : model.Day.ToString()) + ";UpdateBy = "+ (model.UpdateBy == null ? "" : model.UpdateBy.ToString()) + ";DateTime = "+ (model.DateTime == null ? "" : model.DateTime.ToString()) + ";Remarks = "+ (model.Remarks == null ? "" : model.Remarks.ToString()) + "");
			parameters[0].Value = model.UserID == null ? (object)DBNull.Value : model.UserID ;
			parameters[1].Value = model.UserName == null ? (object)DBNull.Value : model.UserName ;
			parameters[2].Value = model.UserGroup == null ? (object)DBNull.Value : model.UserGroup ;
			parameters[3].Value = model.Department == null ? (object)DBNull.Value : model.Department ;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update LMMSUserAttendanceHis set ");
			...
			parameters[10].Value = model.Remarks == null ? (object)DBNull.Value : model.Remarks ;
			 ...
			 DBHelp.Reports.LogFile.DebugLog("AUTOCODE","NameSpace:Common.DAL" , "Class:LMMSUserAttendanceHis_DAL" , "Function:		public bool Update(Common.Model.LMMSUserAttendanceHis_Model model)"  + "TableName:LMMSUserAttendanceHis" , ";UserID = "+ (model.UserID == null ? "" : model.UserID.ToString() ) + ";UserName = "+ (model.UserName == null ? "" : model.UserName.ToString() ) + ";UserGroup = "+ (model.UserGroup == null ? "" : model.UserGroup.ToString() ) + ";Department = "+ (model.Department == null ? "" : model.Department.ToString() ) + ";Shift = "+ (model.Shift == null ? "" : model.Shift.ToString() ) + ";Attendance = "+ (model.Attendance == null ? "" : model.Attendance.ToString() ) + ";OnLeave = "+ (model.OnLeave == null ? "" : model.OnLeave.ToString() ) + ";Day = "+ (model.Day == null ? "" : model.Day.ToString() ) + ";UpdateBy = "+ (model.UpdateBy == null ? "" : model.UpdateBy.ToString() ) + ";DateTime = "+ (model.DateTime == null ? "" : model.DateTime.ToString() ) + ";Remarks = "+ (model.Remarks == null ? "" : model.Remarks.ToString() ) + "");
		...
		public SqlCommand UpdateCommand(Common.Model.LMMSUserAttendanceHis_Model model)
		{
			...
			parameters[10].Value = model.Remarks == null ? (object)DBNull.Value : model.Remarks ;
			 ...
			 DBHelp.Reports.LogFile.DebugLog("AUTOCODE","NameSpace:Common.DAL" , "Class:LMMSUserAttendanceHis_DAL" , "Function:		public SqlCommand UpdateCommand(Common.Model.LMMSUserAttendanceHis_Model model)"  + "TableName:LMMSUserAttendanceHis" , ";UserID = "+ (model.UserID == null ? "" : model.UserID.ToString()) + ";UserName = "+ (model.UserName == null ? "" : model.UserName.ToString()) + ";UserGroup = "+ (model.UserGroup == null ? "" : model.UserGroup.ToString()) + ";Department = "+ (model.Department == null ? "" : model.Department.ToString()) + ";Shift = "+ (model.Shift == null ? "" : model.Shift.ToString()) + ";Attendance = "+ (model.Attendance == null ? "" : model.Attendance.ToString()) + ";OnLeave = "+ (model.OnLeave == null ? "" : model.OnLeave.ToString()) + ";Day = "+ (model.Day == null ? "" : model.Day.ToString()) + ";UpdateBy = "+ (model.UpdateBy == null ? "" : model.UpdateBy.ToString()) + ";DateTime = "+ (model.DateTime == null ? "" : model.DateTime.ToString()) + ";Remarks = "+ (model.Remarks == null ? "" : model.Remarks.ToString()) + "");
			return DBHelp.SqlDB.generateCommand(strSql.ToString(),parameters);
		}
		...
		public bool Delete()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from LMMSUserAttendanceHis ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
};

			 DBHelp.Reports.LogFile.DebugLog("AUTOCODE","NameSpace:Common.DAL" , "Class:LMMSUserAttendanceHis_DAL" , "Function:		public bool Delete()"  + "TableName:LMMSUserAttendanceHis" , "");
			int rows=DBHelp.SqlDB.ExecuteSql(strSql.ToString(),parameters);
			if (rows > 0)
			{
				return true;
		...
		public SqlCommand DeleteCommand()
		{
			...
			SqlParameter[] parameters = {
			 ...
			 DBHelp.Reports.LogFile.DebugLog("AUTOCODE","NameSpace:Common.DAL" , "Class:LMMSUserAttendanceHis_DAL" , "Function:		public SqlCommand DeleteCommand()"  + "TableName:LMMSUserAttendanceHis" , "");
			return DBHelp.SqlDB.generateCommand(strSql.ToString(),parameters);
		}
		/// <summary>
		/// 删除一条数据
		...
		public SqlCommand DeleteAllCommand( )
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from LMMSUserAttendanceHis ");
			 DBHelp.Reports.LogFile.DebugLog("AUTOCODE","NameSpace:Common.DAL" , "Class:LMMSUserAttendanceHis_DAL" , "Function:		public SqlCommand DeleteAllCommand( )"  + "TableName:LMMSUserAttendanceHis" , "");
		...
		public Common.Model.LMMSUserAttendanceHis_Model GetModel()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 UserID,UserName,UserGroup,Department,Shift,Attendance,OnLeave,Day,UpdateBy,DateTime,Remarks from LMMSUserAttendanceHis ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
};

			 DBHelp.Reports.LogFile.DebugLog("AUTOCODE","NameSpace:Common.DAL" , "Class:LMMSUserAttendanceHis_DAL" , "Function:		public Common.Model.LMMSUserAttendanceHis_Model GetModel()"  + "TableName:LMMSUserAttendanceHis" , "");
			Common.Model.LMMSUserAttendanceHis_Model model=new Common.Model.LMMSUserAttendanceHis_Model();
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM LMMSUserAttendanceHis ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "LMMSUserAttendanceHis";
			parameters[1].Value = "";
