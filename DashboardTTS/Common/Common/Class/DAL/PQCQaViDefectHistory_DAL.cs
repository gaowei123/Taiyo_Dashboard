...
{
    /// <summary>
    /// 数据访问类:PQCQaViDefectHistory_DAL
    /// </summary>
    public class PQCQaViDefectHistory_DAL
    {
        public PQCQaViDefectHistory_DAL()
        { }
        #region  Method
        ...
        public void Add(Common.Class.Model.PQCQaViDefectHistory_Model model)
        {
            ...
            strSql.Append("insert into PQCQaViDefectHistory(");
            ...
            DBHelp.Reports.LogFile.DebugLog("AUTOCODE", "NameSpace:Common.DAL", 
                "Class:PQCQaViDefectHistory_DAL", 
                "Function:		public void Add(Common.Class.Model.PQCQaViDefectHistory_Model model)" + 
                "TableName:PQCQaViDefectHistory", ";id = " + (model.id == null ? "" : model.id.ToString()) + 
        ...
        public SqlCommand AddCommand(Common.Class.Model.PQCQaViDefectHistory_Model model,SqlCommand cmd=null)
        {
            ...
            DBHelp.Reports.LogFile.DebugLog("AUTOCODE", "NameSpace:Common.DAL",
                "Class:PQCQaViDefectHistory_DAL",
                "Function:		public SqlCommand AddCommand(Common.Class.Model.PQCQaViDefectHistory_Model model)" +
                "TableName:PQCQaViDefectHistory", ";id = " + (model.id == null ? "" : model.id.ToString()) +
                ";jobid = " + (model.jobid == null ? "" : model.jobid.ToString()) +
                ";trackingID = " + (model.trackingID == null ? "" : model.trackingID.ToString()) +
                ";machineID = " + (model.machineID == null ? "" : model.machineID.ToString()) +
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update PQCQaViDefectHistory set ");
            strSql.Append("id=@id,");
            ...
            DBHelp.Reports.LogFile.DebugLog("AUTOCODE", "NameSpace:Common.DAL", 
                "Class:PQCQaViDefectHistory_DAL", 
                "Function:		public bool Update(Common.Class.Model.PQCQaViDefectHistory_Model model)" + 
                "TableName:PQCQaViDefectHistory", ";id = " + (model.id == null ? "" : model.id.ToString()) + 
                ";jobid = " + (model.jobid == null ? "" : model.jobid.ToString()) + 
                ";trackingID = " + (model.trackingID == null ? "" : model.trackingID.ToString()) + 
                ";machineID = " + (model.machineID == null ? "" : model.machineID.ToString()) + 
        ...
        public SqlCommand UpdateCommand(Common.Class.Model.PQCQaViDefectHistory_Model model)
        {
            ...
            DBHelp.Reports.LogFile.DebugLog("AUTOCODE", "NameSpace:Common.DAL",
                "Class:PQCQaViDefectHistory_DAL",
                "Function:		public SqlCommand UpdateCommand(Common.Class.Model.PQCQaViDefectHistory_Model model)" +
                "TableName:PQCQaViDefectHistory", ";id = " + (model.id == null ? "" : model.id.ToString()) +
                ";jobid = " + (model.jobid == null ? "" : model.jobid.ToString()) +
                ";trackingID = " + (model.trackingID == null ? "" : model.trackingID.ToString()) +
                ";machineID = " + (model.machineID == null ? "" : model.machineID.ToString()) +
        ...
        public bool Delete()
        {
            //该表无主键信息，请自定义主键/条件字段
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from PQCQaViDefectHistory ");
            strSql.Append(" where ");
            SqlParameter[] parameters = {
};

            DBHelp.Reports.LogFile.DebugLog("AUTOCODE", "NameSpace:Common.DAL", "Class:PQCQaViDefectHistory_DAL", "Function:		public bool Delete()" + "TableName:PQCQaViDefectHistory", "");
            int rows = DBHelp.SqlDB.ExecuteSql(strSql.ToString(), parameters);
            if (rows > 0)
            {
                return true;
        ...
        public SqlCommand DeleteCommand()
        {
            ...
            DBHelp.Reports.LogFile.DebugLog("AUTOCODE", "NameSpace:Common.DAL", "Class:PQCQaViDefectHistory_DAL", "Function:		public SqlCommand DeleteCommand()" + "TableName:PQCQaViDefectHistory", "");
            return DBHelp.SqlDB.generateCommand(strSql.ToString(), parameters);
        }
        /// <summary>
        /// 删除一条数据
        ...
        public SqlCommand DeleteAllCommand()
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from PQCQaViDefectHistory ");
            DBHelp.Reports.LogFile.DebugLog("AUTOCODE", "NameSpace:Common.DAL", "Class:PQCQaViDefectHistory_DAL", "Function:		public SqlCommand DeleteAllCommand( )" + "TableName:PQCQaViDefectHistory", "");
        ...
        public Common.Class.Model.PQCQaViDefectHistory_Model GetModel()
        {
            //该表无主键信息，请自定义主键/条件字段
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 id,jobid,trackingID,machineID,dateTime,materialPartNo,jigNo,model,cavityCount,userName,userID,startTime,stopTime,day,shift,status,remark_1,remark_2,defectCodeID,defectCode,defectDescription,rejectQty,rejectQtyHour01,rejectQtyHour02,rejectQtyHour03,rejectQtyHour04,rejectQtyHour05,rejectQtyHour06,rejectQtyHour07,rejectQtyHour08,rejectQtyHour09,rejectQtyHour10,rejectQtyHour11,rejectQtyHour12,lastUpdatedTime,remarks,processes,updatedTime from PQCQaViDefectHistory ");
            strSql.Append(" where ");
            SqlParameter[] parameters = {
};

            DBHelp.Reports.LogFile.DebugLog("AUTOCODE", "NameSpace:Common.DAL", "Class:PQCQaViDefectHistory_DAL", "Function:		public Common.Class.Model.PQCQaViDefectHistory_Model GetModel()" + "TableName:PQCQaViDefectHistory", "");
            Common.Class.Model.PQCQaViDefectHistory_Model model = new Common.Class.Model.PQCQaViDefectHistory_Model();
        ...
        public DataSet GetList(string sTrackingID)
        {
            ...
            strSql.Append(" FROM PQCQaViDefectHistory ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "PQCQaViDefectHistory";
			parameters[1].Value = "";
