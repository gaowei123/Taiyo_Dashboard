...
,case when b.defectDescription = 'Mould' and a.supplier = 'TTS'    then 'TTS'
      when b.defectDescription = 'Mould' and a.supplier = 'Vendor' then 'Vendor'
      else b.defectDescription end as defectDescription
